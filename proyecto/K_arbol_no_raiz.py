...
bw2c=af.comparar_arboles_m2("dist_top_matrix_b2c.csv","dist_top_matrix_w2c.csv")
bw4c=af.comparar_arboles_m2("dist_top_matrix_b4c.csv","dist_top_matrix_w4c.csv")
bw8c=af.comparar_arboles_m2("dist_top_matrix_b8c.csv","dist_top_matrix_w8c.csv")
bw16c=af.comparar_arboles_m2("dist_top_matrix_b16c.csv","dist_top_matrix_w16c.csv")
...
union_t2=list(set( set(bw2c) & set(bw4c) ) & set( set(bw8c) & set(bw16c) ))
